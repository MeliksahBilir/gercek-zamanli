...
public class Main5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView webview = (WebView) findViewById(R.id.veb_nem);
        webview.getSettings().setJavaScriptEnabled(true);
        webview.loadUrl("http://api.thingspeak.com/channels/385862/charts/2?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line&update=15");
